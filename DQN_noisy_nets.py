...
Uses noisy networks for exploration in place of an epsilon-greedy policy
"""
...
class DQNAgent:
    ...
    def build_model(self, n_outputs):
        ...
        x = Flatten()(x)
        x = NoisyDense(512, sigma=0.5, use_factorised=False, activation='relu')(x)
        x = NoisyDense(256, sigma=0.5, use_factorised=False, activation='relu')(x)
        x = NoisyDense(64, sigma=0.5, use_factorised=False, activation='relu')(x)
        outputs = NoisyDense(n_outputs, sigma=0.5, use_factorised=False, activation='relu')(x)
    ...
    def replay(self, batch_size):
        ...
        for state, action, reward, next_state, done in sars_batch:
            ...
            target = self.get_target_q_value(next_state, reward)
